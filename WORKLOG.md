...
- Added a transparent Windows desktop widget for FIFA 2026 match tracking.
- Added startup support through `outputs/open-desktop-widget.bat`.
- The widget shows all remaining matches today by default and all matches tomorrow on hover.
